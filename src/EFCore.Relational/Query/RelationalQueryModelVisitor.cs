...
namespace Microsoft.EntityFrameworkCore.Query
{
    ...
    public class RelationalQueryModelVisitor : EntityQueryModelVisitor
    {
        ...
        private class GroupByPreProcessor : QueryModelVisitorBase
        {
            ...
            public override void VisitQueryModel(QueryModel queryModel)
            {
                ...
                if (queryModel.ResultOperators.Any(o => o is GroupResultOperator)
                    && _queryCompilationContext.QueryAnnotations.Any(a => a is IncludeResultOperator)
            ...
            {
                var groupResultOperators = queryModel.ResultOperators.OfType<GroupResultOperator>();
        ...
        protected override void PreProcessGroupBy(QueryModel queryModel)
        {
            Check.NotNull(queryModel, nameof(queryModel));
